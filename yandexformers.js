...
// - пробовал улучишь с помощью кучи (max heap), что в теории улучшает сложность до K * log N, но на практике K довольно большие (близкие к N), поэтому так же TLE на 44 тесте

...
function decode(message, replaces) {
  ...
  // Так мы гарантируем, что "более поздние правила имеют большие приоритет"
  ...
  for (const [start, value] of entries) {
    ...
    // не забываем обновить смещение, чтобы следующие start был верным для уже измененной строки
